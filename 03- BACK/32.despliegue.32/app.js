...
// const cors = require("cors"); LO DESCONECTAMOS AL LEVANTARLO
...
//Configuramos la carpeta public para servir archivos estáticos (VER CLASE 27)
app.use(express.static('?'));

/**AGREGAMOS LA HOME VER CLASE 27***/
app.get('/', (req,res)=>{
